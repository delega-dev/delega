...
class PushNotificationSend(BaseModel):
    ...
    title: str
    body: str
    icon: Optional[str] = "/assets/icon-192.png"
    badge: Optional[str] = "/assets/badge-72.png"
    tag: Optional[str] = None           # Replaces existing notification with same tag
    url: Optional[str] = None           # URL to open when clicked
    task_id: Optional[int] = None       # Open specific task
    silent: Optional[bool] = False      # Deliver silently (no sound/vibrate)
    require_interaction: Optional[bool] = False  # Keep visible until dismissed
